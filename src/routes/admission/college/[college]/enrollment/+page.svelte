    ...
    <form method="POST" action="?/submitApplication" enctype="multipart/form-data" use:enhance={submitApplicationNews}>
        <Card.Root class="shadow-sm shadow-black dark:shadow-white w-full sm:max-w-2xl mx-auto ">
            ...
            <Card.Content class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-1.5">
                    <Label for="primaryGraduation" class="font-bold">Primary School Date Graduated:</Label>
                    <Input name="primaryGraduation" type="date" placeholder="Enter Your Month and Year Secondary Graduation" />
                ...
                <div class="flex flex-col gap-1.5">
                    <Label for="secondaryGraduation" class="font-bold">Secondary School Date Graduated:</Label>
                    <Input name="secondaryGraduation" type="date" placeholder="Enter Your Month and Year Secondary Graduation" />
